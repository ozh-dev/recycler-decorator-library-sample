...
open class ScaleLinePageIndicatorDecoration(
    ...
    val colorDefaultActive: Int = context.resources.getColor(colorActiveResource)
    val colorDefaultInactive: Int = context.resources.getColor(colorInactiveResource)
